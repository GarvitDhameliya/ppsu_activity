...
const Export2 = (props) => {
    ...
    const exportpdf = () => {
        ...
        props.data[0].map((data, ind) => {
            report_data.push([ind + 1, data.enrollmentNo, data.name, data.class.betch, data.class.name, data.totalPoint, data.requests.length])
        })
        ...
        autoTable(doc, {
            ...
            showHead: 'everyPage',
            head: [['index', 'Enrollment No', 'Name', 'Batch', 'Class', 'TotalPoint', 'No. of Request']],
            body: report_data
        })
    ...
    const exportCsv = () => {
        let csvRow = []
        let a = [['', 'Enrollment No', 'Name', 'Batch', 'Class', 'TotalPoint', 'No. of Request']]

        props.data[0].map((data, ind) => {
            a.push([data.enrollmentNo, data.name, data.class.betch, data.class.name, data.totalPoint, data.requests.length])
        })
